...
public class NotificationRestControllerTests {
	...
	public void getNotificationsPaginated() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/api/notifications/user/99"))
	...
	public void getCountNotificationById() throws Exception {
		...
		MvcResult mvcResult = mockMvc.perform(
				MockMvcRequestBuilders.get("/api/notifications/count/99").accept(MediaType.APPLICATION_JSON))
				.andReturn();
